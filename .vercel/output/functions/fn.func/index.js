...
var init_index2 = __esm({
  ...
  `}`;
    ...
    navicon = { "navicon": { "width": 1536, "height": 1792, "paths": [{ "d": "M1536 1344v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45zM1536 832v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45zM1536 320v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45z" }] } };
  ...
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let images = [
        ...
        { name: "Yoo Pottery", src: "/pottery.png" },
...
<p id="contents" class="svelte-9ohkm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eaque magnam maxime optio tempore, quia, nisi deleniti soluta enim fugiat molestiae possimus natus fugit itaque quam architecto adipisci voluptatum a! Porro deserunt alias repellat eum quibusdam eius officia dolorum id ipsa.</p>
    ...
    css2 = {
      code: `:root[data-theme='light']{background-color:var(--primary-background)}:root[data-theme='dark']{background-color:var(--secondary-background);color:antiquewhite}.nav-container.svelte-ikxr6h.svelte-ikxr6h{position:relative;display:flex;align-items:center;justify-content:space-between;font-family:'Fira Code', monospace}.nav-container.svelte-ikxr6h .header.svelte-ikxr6h{flex-basis:10%;text-align:left}.header.svelte-ikxr6h h1.svelte-ikxr6h{color:var(--primary-color);text-align:center;font-family:"Allura"}.nav-container.svelte-ikxr6h .nav-links.svelte-ikxr6h{display:flex;justify-content:space-around;flex-basis:85%;width:100%;margin-right:10px}.nav-links.svelte-ikxr6h nav.svelte-ikxr6h{padding:5px;font-size:12px;font-weight:bold;text-transform:capitalize;cursor:pointer}.nav-links.svelte-ikxr6h nav.svelte-ikxr6h:hover{color:var(--primary-color)}.nav-container.svelte-ikxr6h nav a.svelte-ikxr6h{text-decoration:none}.nav-links.svelte-ikxr6h #active.svelte-ikxr6h{background-color:var(--primary-color);border-radius:5px;color:black}.nav-links.svelte-ikxr6h #active.svelte-ikxr6h:hover{color:#000}.theme.svelte-ikxr6h.svelte-ikxr6h{flex-basis:5%;display:flex;justify-content:center;align-items:center}@media(width < 550px){.nav-container.svelte-ikxr6h .header.svelte-ikxr6h{display:none}.nav-container.svelte-ikxr6h .nav-links.svelte-ikxr6h{flex-basis:80%}.theme.svelte-ikxr6h.svelte-ikxr6h{flex-basis:5%}}`,
      map: null
    };
    NavigationBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css2);
      return `<div class="nav-container svelte-ikxr6h"><div class="header svelte-ikxr6h"><header><h1 class="svelte-ikxr6h">Yoo<br>Brands</h1></header></div>
    <div class="nav-links svelte-ikxr6h"><nav id="active" class="svelte-ikxr6h"><a data-sveltekit-preload-data="tap" href="/" class="svelte-ikxr6h">home</a></nav>
        <nav class="svelte-ikxr6h"><a data-sveltekit-preload-data="tap" href="/" class="svelte-ikxr6h">stores</a></nav>
        <nav class="svelte-ikxr6h"><a data-sveltekit-preload-data="tap" href="/" class="svelte-ikxr6h">order</a></nav>
        <nav class="svelte-ikxr6h"><a data-sveltekit-preload-data="tap" href="/contact" class="svelte-ikxr6h">contact</a></nav></div>
    
    <div class="theme svelte-ikxr6h">${validate_component(Icon, "Icon").$$render($$result, { data: moonO, scale: "1.5" }, {}, {})}</div>
</div>`;
    });
...
var css$22, ContactIcon, css$12, Form, css3, Page2;
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/contact/_page.svelte.js"() {
    ...
    css$12 = {
      code: `.form-container.svelte-xmyni3.svelte-xmyni3{width:100%;margin:20px 0;margin-bottom:0px;display:flex;flex-direction:column;align-items:center}input.svelte-xmyni3.svelte-xmyni3{caret-color:orange;padding:5px 15px;width:60%;max-width:250px;height:30px;margin:10px 0;background-color:transparent;border:1px solid var antiquewhite;font-size:1em;color:gray;font-family:"Fira Code", sans-serif;border-radius:5px;outline:none}#light.svelte-xmyni3 input.svelte-xmyni3{caret-color:#333;color:black;border:2px solid black}input.svelte-xmyni3.svelte-xmyni3:focus{outline:none}input.svelte-xmyni3.svelte-xmyni3::placeholder{color:antiquewhite;font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;opacity:80%}#light.svelte-xmyni3 input.svelte-xmyni3::placeholder{color:black;opacity:80%}button.svelte-xmyni3.svelte-xmyni3{width:60px;margin:10px 0;padding:7px;background-color:antiquewhite;font-size:1.1 em;border-radius:10px;border:none;font-weight:bolder;transition:all .5s linear}#light.svelte-xmyni3 button.svelte-xmyni3:hover,button.svelte-xmyni3.svelte-xmyni3:hover{background-color:orange;color:black}#light.svelte-xmyni3 button.svelte-xmyni3{background-color:black;color:#fff}`,
      map: null
    };
    Form = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="form-container svelte-xmyni3"${add_attribute("id", themeColor == "light" && "light", 0)}><input type="text" placeholder="Full Name" class="svelte-xmyni3"${add_attribute("this", inputRef, 0)}>
        <input type="text" placeholder="Email" class="svelte-xmyni3">
        <input type="text" placeholder="Message" class="svelte-xmyni3">
        <button class="svelte-xmyni3">send</button>
</div>`;
    });
    css3 = {
      code: ".nav-icon.svelte-fcy9aq.svelte-fcy9aq{position:absolute;top:1em;left:1em}a.svelte-fcy9aq.svelte-fcy9aq{text-decoration:none}.theme-icon.svelte-fcy9aq.svelte-fcy9aq{position:absolute;top:1em;right:1em;z-index:2}.page-container.svelte-fcy9aq.svelte-fcy9aq{margin:0;padding:0;height:100vh;display:flex;flex-direction:column;justify-content:center;align-items:center}.page-container.svelte-fcy9aq div header.svelte-fcy9aq{cursor:pointer}.page-container.svelte-fcy9aq div header h1.svelte-fcy9aq{font-weight:900;text-align:center;font-family:'Allura', cursive;font-size:2.5em;line-height:0.9em;background:linear-gradient(antiquewhite, orange);-webkit-background-clip:text;background-clip:text;color:transparent}main div.svelte-fcy9aq header h1.svelte-fcy9aq:hover{opacity:80%}#yoo-light.svelte-fcy9aq.svelte-fcy9aq{background:linear-gradient(black, orange);-webkit-background-clip:text;background-clip:text;color:transparent}",
      map: null
    };
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let themeColor;
      $$result.css.add(css3);
      return `<div class="page-container svelte-fcy9aq"><div class="nav-icon svelte-fcy9aq">${validate_component(Icon, "Icon").$$render($$result, { data: navicon, scale: "1.2" }, {}, {})}</div>
    
    <div class="theme-icon svelte-fcy9aq">${validate_component(Icon, "Icon").$$render($$result, { data: moonO, scale: "1.5" }, {}, {})}</div>
         <div class="pageName svelte-fcy9aq"><header class="svelte-fcy9aq"><h1${add_attribute("id", "yoo", 0)} class="svelte-fcy9aq"><a href="/" data-sveltekit-preload-data="tap" class="svelte-fcy9aq">Yoo<br>Brands</a></h1></header></div>
